...
if (!projectRoot) {
    projectRoot = Config.getPath('.feflowrc.js');
}
...
class Builder {
    ...
    static createProdConfig(options: BuilderOptions): BaseConfig {
        ...
        const cdn: string = options.cdn || 'now8.gtimg.com';
    ...
    static setExternalPlugin(externals) {
        const newExternals = externals || [
            {
                module: 'react',
                entry: '//now8.gtimg.com/now/lib/16.2.0/react.min.js?_bid=3123',
                global: 'React'
            }, {
                module: 'react-dom',
                entry: '//now8.gtimg.com/now/lib/16.2.0/react-dom.min.js?_bid=3123',
                global: 'ReactDOM'
            }
        ];
